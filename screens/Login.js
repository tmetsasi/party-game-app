  ...
  return (
    <ImageBackground style={AppStyles.imageContainer} source={background}>
      <KeyboardAvoidingView 
        ...
        <Text style={[AppStyles.lightText, AppStyles.header]}>Tervetuloa pelaamaan!</Text>
        ...
        <View style={[AppStyles.rowContainer, AppStyles.bottomMargin]}>
          ...
          <InlineTextButton text="Korjataan asia" onPress={() => navigation.navigate("ResetPassword")} />
        </View>
        <Button title="Kirjaudu sisään" onPress={login} color="#f7b267" />
      </KeyboardAvoidingView>
    </ImageBackground>
  );
}
